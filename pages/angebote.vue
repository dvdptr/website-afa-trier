    ...
    <div class="mx-auto w-4/6 py-8">
      <section>
        ...
        <section class="pb-4">
          ...
          zählt:
          <li>
            eine Erstorientierung darüber, was hier vor Ort und in naher Zukunft
            passieren wird
          </li>
          <li>
            eine Vorbereitung auf den Ablauf des Asylverfahrens und der
            dazugehörigen Termine
          </li>
          <li>
            sonstige soziale Belange, die sich während des Aufenthalts ergeben.
          </li>
          Darüber hinaus unterstützen wir euch bei der Vermittlung zu weiteren
        ...
        <p class="pb-4">
          ...
          die von sportlichen Aktivitäten bis zu künstlerischen Kreativgruppen
          reichen und ohne Anmeldung für Euch offen sind. Hier (verlinken!)
          findet Ihr die Übersicht der aktuellen Angebote. Des Weiteren kann bei
          Bedarf die Überleitung zu therapeutischen Gruppenangeboten und Hilfen
          erfolgen.
        </p>
